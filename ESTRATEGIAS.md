...
| Trading de pares (dólar-neutral) | 4 pares petroleras (XOM/CVX, COP/XOM, COP/CVX, SHEL/BP) | `docs/ideas/003-trading-de-pares.md` | 02 · AED — ampliado a n=73 eventos independientes, resultado combinado no significativo (p=0.56), XOM/CVX no replicó en los otros 3 pares | **RECHAZAR** esta especificación (falso positivo por comparaciones múltiples) | — | 2026-09-16 |
